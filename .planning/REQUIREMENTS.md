...
- [ ] **INFRA-01**: Python 3.11+ project initialized with FastAPI, AsyncAnthropic, Aerospike Python client (19.1.0), RestrictedPython (8.2)
- [ ] **INFRA-02**: Aerospike running via Docker with startup health check (read-after-write validates namespace exists before accepting traffic)
...
- [ ] **INFRA-05**: Environment configuration via .env (ANTHROPIC_API_KEY, AEROSPIKE_HOST, BLAND_API_KEY, OKTA_DOMAIN, OKTA_CLIENT_ID)
